...
<p align="center">
  <img src="chain_standalone.png" alt="Example progress chain from the CrowdMath dataset" width="600">
  <br>
  <em>An example progress chain showing how student posts are annotated with discourse labels.</em>
</p>

## File format

`dataset/dataset.json` is a JSON array. Each element is a **progress chain** object
...
@misc{muckatira2026crowdmathdatasetcrowdsourcedmathematical,
      ...
      author={Sherin Muckatira and Jesse Geneson and Slava Gerovitch and Pavel Etingof and Mikhail Gronas and Anna Rumshisky},
      year={2026},
      eprint={2606.06526},
      archivePrefix={arXiv},
      primaryClass={cs.AI},
